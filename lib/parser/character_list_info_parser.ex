defmodule AdmiralStatsParser.Parser.CharacterListInfoParser do
  ...
  @mandatory_keys %{
    1 => %{
      ...
      "status_img" => &ParserUtil.is_string/1,
    },
    2 => %{
      "book_no" => &is_integer/1,
      "lv" => &is_integer/1,
    ...
    3 => %{
      ...
      "tc_img" => &ParserUtil.is_string/1,
      "exp_percent" => &is_integer/1,
      "max_hp" => &is_integer/1,
      "real_hp" => &is_integer/1,
      "damage_status" => &ParserUtil.is_string/1,
      "slot_num" => &is_integer/1,
      "slot_equip_name" => &ParserUtil.is_string_list/1,
      "slot_amount" => &ParserUtil.is_integer_list/1,
      "slot_disp" => &ParserUtil.is_string_list/1,
      "slot_img" => &ParserUtil.is_string_list/1,
    }
  }
